...
public class Informatique extends Complementaire {
    ...
    protected String TABLE = "informatique";
    ...
    public Informatique(Integer id, String label, String description, Date created_at, Date modified_at) {
        super();
        super.TABLE = this.TABLE;
        super.id = id;
        this.label = label;
    ...
    @Override
    public Informatique setId(Integer id) {
        super.setId(id);
        return this;
    }

    @Override
    public Informatique setId_utilisateur(Integer id_utilisateur) {
    ...
    public Informatique setLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public Informatique setDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public Informatique setCreated_at(Date created_at) {
        this.created_at = created_at;
        return this;
    }
    ...
    public Informatique setModified_at(Date modified_at) {
        this.modified_at = modified_at;
        return this;
    }
}
