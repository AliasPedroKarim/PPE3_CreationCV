...
public class PanneauFormModification extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panneauNom = new PanneauChamp();
        panneauPrenom = new PanneauChamp();
        panneauIdentifiant = new PanneauChamp();
        panneauCourriel = new PanneauChamp();
        panneauNumeroTelephone = new PanneauChamp();
        panneauDateNaissance = new PanneauChamp();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (nomOK && prenomOK && identifiantOK && courrielOK && numeroTelephoneOK && dateNaissanceOK) {
            ...
            if (resultat > 0) {
                panneauPereModification.getObjAutreFenetreAdmin().getjLabelEtatVider().setForeground(Reference.COLOR_VALIDATED);
                ...
                panneauPereModification.setForeground(Reference.COLOR_NOT_VALIDATED);
    ...
    private PanneauChamp panneauCourriel;
    private PanneauChamp panneauDateNaissance;
    private PanneauChamp panneauIdentifiant;
    private PanneauChamp panneauNom;
    private PanneauChamp panneauNumeroTelephone;
    private PanneauChamp panneauPrenom;
