...
public class PanneauFormConnexionAdmin extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panneauIdentifiant = new PanneauChamp();
        jButtonConnexion = new JButton();
        jLabelEtatConnexion = new JLabel();
        jLabel1 = new JLabel();
        panneauMdp = new PanneauChampSecret();
    ...
    private JLabel jLabelEtatConnexion;
    private PanneauChamp panneauIdentifiant;
    private PanneauChampSecret panneauMdp;
